...
const Hero = () => {
  ...
  return (
    <section className="section-wrapper grid grid-cols-1 lg:grid-cols-3 gap-5">
      {/* left side */}
      <div className="lg:h-[calc(100dvh-80px)] lg:col-span-2 relative">
        <img
          src={heroLeft}
          alt="LeftSide"
        ...
        <div className="absolute bottom-5 lg:bottom-10 mx-5 lg:mx-[60px] space-y-3">
          ...
          <p>
            ...
            lorem. Always together.
          </p>
        </div>
      </div>

      {/* right side */}
      <div className="lg:col-span-1 bg-black px-8 py-[30px] space-y-[30px]">
        <h5 className="px-5">OUR MOST POPULAR SERVICES</h5>
        <hr className="border-[#344E71]" />

        <div className="px-5">
          <img src={heroRight} alt="RightSide" className="object-cover mb-6" />
